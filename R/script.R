...
p=plot.imitationLearning.boxplot(CDR.OPT)+facet_grid(Type~Set)
ggsave('../../Paper-VI/figures/j_rnd/boxplot_passive_10x10.png',p,
       width = Width, height = Height.half, units = units, dpi = dpi)
...
p=plot.imitationLearning.boxplot(CDR.DA.EXT)+facet_grid(Type~Set)+
  scale_linetype('New problem instances')+xlab(expression('iteration,' *~i))
ggsave('../../Paper-VI/figures/j_rnd/boxplot_active_10x10.pdf',p,
       width = Width, height = Height.half, units = units, dpi = dpi)
...
levels(CDR.IL$Supervision)=c('Passive IL','NA','Active IL')
p=plot.imitationLearning.boxplot(CDR.IL,MWR)
ggsave('../../Paper-VI/figures/j_rnd/boxplot_summary_10x10.png',
       width = Width, height = Height.half, units = units, dpi = dpi)
