...
compare operations and collect training data with the importance of good 
feature selection and the polysemy of how to report accuracy. 
...
around time step 40, where the SDRs change places in outperforming one another. 
...
achieve on its own. 
 ...
 there will no be one SDR that fits all problem distributions and that custom 
...
\todo[inline]{Show stepwise optimality for a fixed track -- only \jrnd{10}{10}}
