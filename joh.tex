...
comparison for a single randomly generated problem space. \todo{single randomly generated problem space?}
Furthermore, some 
...
we were on the optimal trajectory. As mistakes are bound to made at some 
points, it is interesting to see how the stepwise optimality evolves for its 
...
Let us assume one knows the expert policy $\pi^\star$, which we can query what 
