...
\begin{document}
	...
	\nomenclature[zfssp]{FSP}{permutation flow-shop scheduling problem}
	...
	\nomenclature[J6b]{\jrnd{n}{m}}{job shop random}
	\nomenclature[J6c]{\jrndn{n}{m}}{job shop random-narrow}
	\nomenclature[J6d]{\frnd{n}{m}}{flow shop random}
	...
	A more sophisticated way, would be to create a \emph{new} linear model, where the preference set, $S$, from \cref{eq:prefset} is the union of the preference pairs across the $\ell$ dispatches. \todo{Note \cref{eq:prefset} is not defined until in \cref{sec:datadriven}, as well as the term `full' ranking}
