...
\todo[inline,color=green]{The introduction must be completely re-written to 
reflect what was done in this paper.) -- Ongoing}
...
\todo[inline,color=pink]{Supervised learning (Siggi, etc) -- concentrate on 
this!}
