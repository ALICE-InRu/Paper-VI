...
shows, \phimakespan\ and \phijobWrm\  are similar in value. However, looking at 
...
\phijobWrm\ for both, the weights are similar, yet statistically significant 
...
\phimacFree\ and \phijobWrm, however the additional \phiwait, which causes the 
