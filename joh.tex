...
\begin{figure}
  \centering
  \includegraphics[width=1\linewidth]{figures/{trdat_prob_moveIsOptimal_10x10_SDR_nocolor}.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=1\linewidth]{figures/j_rnd/{trdat_prob_moveIsOptimal_10x10_SDR_xihat_nocolor}.pdf}
