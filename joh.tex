...
each possible operation are given in \cref{tbl:jssp:feat}.
...
(similar to \phiwait\ and \phislots\ in \cref{tbl:jssp:feat}), i.e., the CDRs 
are a combination of those two key attributes and then the SDRs. 
...
%\subsubsection{\jsp\}\label{data:sim:jssp}
...
so significantly for \jsp\, yet completely fail for flow-shop? 
