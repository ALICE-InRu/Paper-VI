...
A very common variant of subclass of \FSP\ in the literature is called 
permutation \fsp, which has the added constraint that the processing order of 
the jobs on the machines must be identical as well, i.e., no passing of jobs 
allowed \cite{Stafford88}.
...
\end{figure}
\todo{Is there a PDF version of this figure?}
...
said\todo{Only said?!} two attributes.  
