...
suitable model, not just staring blindly at the training accuracy. Moreover, 
...
the polysemy of how to report training accuracy. The paper finally concludes in 
...
again \Cref{fig:jssp:example}, if the job with the shortest processing time 
