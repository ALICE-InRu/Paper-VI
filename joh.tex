...
optimal makespan. 
\Cref{sec:gentrdata} goes into how to generate training data, in particular how 
to collect minimal preference pairs without loss of performance 
and discusses the need to create one model irrespective of time step, for the 
sake of simplicity \todo[inline]{ 
and potential of testing robustness later on.}

%sec:gentrdata,sec:liblinear,sec:learningmodels:interpret}.
% 
