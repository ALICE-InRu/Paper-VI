...
Another learning approach is reinforcement learning (RL). In a similar field of 
study, \cite{Zhang95} studied space shuttle payload processing by using 
temporal difference learning. Using improvement heuristics they started with a 
relaxed problem, such that each job was scheduled as early as its 
